...
export default function LibraryPage() {
  ...
  const [form, setForm] = useState({ title: '', author: '', category: 'Textbook', subject: '', locationCode: '', totalCopies: 1, availableCopies: 1 });
            ...
            <Table>
              ...
              <TableBody>
                {books.map((book: {
                  ...
                  subject?: string; locationCode: string; totalCopies: number; availableCopies: number;
                }) => (
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-2"><Label>Total Copies</Label><Input type="number" value={form.totalCopies} min={1} onChange={e => setForm({ ...form, totalCopies: parseInt(e.target.value), availableCopies: parseInt(e.target.value) })} /></div>
            </div>
          </div>
          <DialogFooter>
